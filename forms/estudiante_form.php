...
<?php 
    if($is_update){
        ...
        echo '<input name="id_estudiante" type="hidden" value="'.$_GET["id"].'">';
    }else{
    ...
    ?>
        <input name="key" type="hidden" value="estudiante">
        <div class="row">
            <div class="col s12 m6">
                <label for="">Nombres</label>
                <input name="name" type="text" value="<?php echo $value_table[1] ?>">
            </div>
            <div class="col s12 m6">
                <label for="" >Apellidos</label>
                <input name="last_name" type="text" value="<?php echo $value_table[2] ?>">
            </div>
        ...
        <div class="row">
            <div class="col s12">
                <div class="input-field">
                    ...
                    <textarea name="address" class="materialize-textarea" ><?php echo $value_table[5] ?></textarea>
                </div>
            </div>
        </div>
        <?php 
